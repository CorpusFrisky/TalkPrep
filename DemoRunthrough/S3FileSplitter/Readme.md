...
Once you have edited your function you can use the following command lines to build, test and deploy your function to AWS Lambda from the command line (these examples assume the project name is *S3FileSplitter*):
...
Execute unit tests
```
    cd "S3FileSplitter/test/S3FileSplitter.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "S3FileSplitter/src/S3FileSplitter"
