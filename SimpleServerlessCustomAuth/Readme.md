...
```
    cd "SimpleServerlessCustomAuth"
    dotnet restore
```

Execute unit tests
```
    cd "SimpleServerlessCustomAuth/test/SimpleServerlessCustomAuth.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "SimpleServerlessCustomAuth/src/SimpleServerlessCustomAuth"
